...
- Limiter min gain (approx GR): **-15.83 dB**
...
- MicroDetail recovery: **1.0** (corr=0.9694686547312267, eff_amount=0.16)
...
- Limiter mode: **v2**
- Limiter avg gain (dB): **-5.20** (closer to 0 = less overall limiting)
...
```json
{
  ...
  "lufs_pre": -20.928954382376183,
  "lufs_post": -20.47081836792916,
  "true_peak_dbfs": -1.0000014517944777,
  "limiter_mode": "v2",
  "limiter_min_gain_db": -15.825177935690284,
  "limiter_avg_gr_db": -5.204697555421269,
  ...
  "transient_sculpt": {
    "enabled": false,
    "crest_db": 20.020792509649254,
    "guard": 0.0
  },
  "runtime_sec": 704.0631444454193,
  "out_path": "C:\\Users\\goku\\Documents\\SS-hangman-game\\backend\\data\\jobs\\e7488e068e124bee94f101ef29ad3386\\output\\mastered.wav"
}
```
