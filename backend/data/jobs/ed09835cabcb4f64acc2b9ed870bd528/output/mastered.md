...
- MicroDetail recovery: **1.0** (corr=0.9205766772564099, eff_amount=0.2)
...
```json
{
  ...
  "lufs_pre": -18.107185490513,
  "lufs_post": -16.324600803091965,
  "true_peak_dbfs": -0.9999973855599669,
  "limiter_mode": "v2",
  "limiter_min_gain_db": -9.45148907405684,
  "limiter_avg_gr_db": -2.5186288188784722,
  "sub_f0_hz": 101.98974609375,
  "mono_sub_cutoff_hz": 110.0,
  "mono_sub_mix": 0.52,
  "microdetail": {
    "enabled": 1.0,
    "corr": 0.9205766772564099,
    "guard": 1.0,
    "eff_amount": 0.2,
    "threshold_db": -34.0,
    "max_boost_db": 3.2,
  ...
  "transient_sculpt": {
    "enabled": true,
    "boost_db": 2.233642948691632,
    "mix": 0.34,
    "crest_db": 15.90625942574496,
    "guard": 0.9711491081267967,
    "max_transient_gain_db": 2.233643054962158
  },
  "runtime_sec": 689.1135511398315,
  "out_path": "C:\\Users\\goku\\Documents\\SS-hangman-game\\backend\\data\\jobs\\ed09835cabcb4f64acc2b9ed870bd528\\output\\mastered.wav"
}
```
