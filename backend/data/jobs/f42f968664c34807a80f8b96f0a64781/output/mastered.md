...
- Limiter min gain (approx GR): **-4.50 dB**
...
- MicroDetail recovery: **1.0** (corr=0.9194552851348224, eff_amount=0.16)
...
- Limiter mode: **v2**
- Limiter avg gain (dB): **-1.17** (closer to 0 = less overall limiting)
...
```json
{
  ...
  "lufs_pre": -21.901432549561292,
  "lufs_post": -17.570112282790998,
  "true_peak_dbfs": -0.9999991282316669,
  "limiter_mode": "v2",
  "limiter_min_gain_db": -4.495869433056447,
  "limiter_avg_gr_db": -1.167895429683403,
  "sub_f0_hz": 101.98974609375,
  "mono_sub_cutoff_hz": 110.0,
  "mono_sub_mix": 0.48,
  "microdetail": {
    "enabled": 1.0,
    "corr": 0.9194552851348224,
    "guard": 1.0,
    "eff_amount": 0.16,
    "threshold_db": -36.0,
    "max_boost_db": 2.5,
  ...
  "transient_sculpt": {
    ...
    "boost_db": 1.6,
    "mix": 0.26,
    "crest_db": 15.213301656643464,
    "guard": 1.0,
    "max_transient_gain_db": 1.600000023841858
  },
  "runtime_sec": 470.61934208869934,
  "out_path": "C:\\Users\\goku\\Documents\\SS-hangman-game\\backend\\data\\jobs\\f42f968664c34807a80f8b96f0a64781\\output\\mastered.wav"
}
```
