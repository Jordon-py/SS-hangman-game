...
- MicroDetail recovery: **1.0** (corr=0.8456839826284599, eff_amount=0.18)
...
- Limiter mode: **v2**
- Limiter avg gain (dB): **-1.94** (closer to 0 = less overall limiting)
...
```json
{
  ...
  "lufs_pre": -17.400856892859377,
  "lufs_post": -17.42996210738848,
  "true_peak_dbfs": -0.9999985473410613,
  "limiter_mode": "v2",
  "limiter_min_gain_db": -8.190271634000322,
  "limiter_avg_gr_db": -1.9421907220944934,
  "sub_f0_hz": 87.5244140625,
  "mono_sub_cutoff_hz": 110.0,
  "mono_sub_mix": 0.5,
  "microdetail": {
    "enabled": 1.0,
    "corr": 0.8456839826284599,
    "guard": 1.0,
    "eff_amount": 0.18,
    "threshold_db": -35.0,
    "max_boost_db": 3.0,
  ...
  "transient_sculpt": {
    "enabled": true,
    "boost_db": 0.700850989789533,
    "mix": 0.32,
    "crest_db": 17.904375626951143,
    "guard": 0.3504254948947665,
    "max_transient_gain_db": 0.7008509635925293
  },
  "runtime_sec": 824.6345188617706,
  "out_path": "C:\\Users\\goku\\Documents\\SS-hangman-game\\backend\\data\\jobs\\999658fd3faa482ea37c40ec83220242\\output\\mastered.wav"
}
```
